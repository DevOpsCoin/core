      ...
      <main className="max-w-4xl mx-auto mt-10 mb-16 p-6 bg-gray-900 rounded-xl border border-cyan-700/40 shadow-lg space-y-10">
        ...
        <article className="border-b border-cyan-700/30 pb-6 mb-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            We're kicking off the stealth build phase for $DEVOPS. Over the next few weeks, we'll
            refine the BNB deployment, finalize tokenomics, and begin internal testing for the
        ...
        <article className="border-b border-cyan-700/30 pb-6 mb-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            The Ship-It Fund is our commitment to supporting open-source DevOps projects. A portion
            of each transaction fee will flow directly to community grants — fueling innovation
