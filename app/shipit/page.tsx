      ...
      <div className="relative" style={{ zIndex: 3 }}>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 text-lg">
            The <strong>Ship-It Fund</strong> is the heart of $DEVOPS — a community-driven movement
            that empowers builders, meme hackers, and open-source creators. It fuels{" "}
            <strong>fun, useful, and innovative open-source projects</strong> across all domains —
            not just DevOps tooling — to push culture, creativity, and code forward.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
            <li>
              <strong>Automatic funding:</strong> 5% of total token supply + 0.5% of all taxed
              transactions (when enabled) flow to the Ship-It Fund wallet.
            </li>
            <li>
              Grants may be distributed on a <strong>rolling basis</strong> or through themed{" "}
              <strong>funding rounds</strong>.
            </li>
            <li>
              Fund activity is <strong>public and on-chain</strong>, ensuring transparency.
            </li>
            <li>Builders are encouraged to ship fast, iterate, and have fun.</li>
          </ul>
          <p className="text-gray-400 text-sm italic">
            The Ship-It Fund is personally bootstrapped in its early stages. Initial grants will be
            modest and scale with Treasury growth.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 mb-4">
            The Ship-It Fund supports individuals and small teams building open-source projects that
            embody DevOps culture, creativity, and community energy.
          </p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 mb-4">
            Every funded project, grant transaction, and voting round will be published publicly
            on-chain and mirrored to GitHub for full transparency. All fund movements are traceable
            through the Ship-It Fund wallet on BscScan.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 mb-4">
            Have something cool in the works? We’d love to see it. Submissions are open — we review
            on a rolling basis and highlight promising projects publicly.
          </p>
        ...
        <section className="container max-w-4xl mx-auto mt-8 p-4 bg-gray-800 rounded-lg text-center border border-cyan-700/40">
          ...
          <p className="text-gray-300">
            Ship-It Fund grants are distributed in{" "}
            <strong>$DEVOPS (BNB Smart Chain — BEP-20)</strong>. Recipients will need a compatible
            wallet such as
            <a
          ...
          <p className="text-gray-400 text-sm mt-2">
            Early distributions will be modest while the Treasury and community fund grow — early
            support is about building the ecosystem together.
          </p>
        </section>
        ...
        <section className="mb-10 mt-8">
          ...
          <p className="text-gray-400 text-sm">
            The Ship-It Fund is a community initiative, not an investment vehicle. All support is
            discretionary and focused on advancing open-source innovation. Early grants will be
            small and experimental as the Treasury expands sustainably.
          </p>
        </section>
