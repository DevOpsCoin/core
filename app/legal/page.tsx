  ...
  return (
    <main className="max-w-3xl mx-auto mt-8 p-8 bg-gray-900 rounded-xl shadow-lg text-white">
      ...
      <section className="mb-8 text-gray-300">
        ...
        <p className="mt-2">
          DevOpsCoin LLC is a legally registered business entity under the New Mexico Limited
          Liability Company Act (Chapter 53, Article 19, NMSA 1978).
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-300 mb-4">
          The official Certificate of Organization issued by the New Mexico Secretary of State is
          available for verification below. All materials in the <code>/assets</code> directory are
          official documents hosted directly by DevOpsCoin LLC.
        </p>
        <a
      ...
      <section className="mt-10 text-sm text-gray-400 border-t border-gray-700 pt-4 leading-relaxed">
        ...
        <p>
          The information provided on this website, including any linked documents, is for
          informational purposes only and does not constitute financial, investment, legal, or tax
          advice. DevOpsCoin LLC makes no representations or warranties of any kind, express or
          implied, regarding the accuracy or completeness of this information.
        </p>
        <p className="mt-3">
          The DevOpsCoin ($DEVOPS) token does not represent equity, ownership, voting rights, or
          financial interest in DevOpsCoin LLC or any affiliated entity. Tokens are not investment
          contracts and should not be considered securities. Participation in the $DEVOPS ecosystem
          is entirely at your own risk.
        </p>
        <p className="mt-3">
          DevOpsCoin LLC is not a financial institution, broker, or investment advisor. No
          regulatory body has reviewed or approved any content on this site or related
          documentation.
        </p>
        <p className="mt-3">
          By accessing or using this website, you agree to the terms outlined in this Legal &
          Disclosures page.
        </p>
        <p className="mt-3 italic text-yellow-300">
          Any previous token deployments on Solana were experimental and are no longer active. The
          official $DEVOPS token will launch on the BNB Smart Chain in January 2026.
        </p>
      </section>
      ...
      <section className="mt-8 text-sm text-gray-400 border-t border-gray-700 pt-4">
        ...
        <p>
          "$DEVOPS," "DevOpsCoin," and associated brand marks, logos, and taglines (including “Dev
          Culture Meets Degen” and “Ship It To The Moon”) are trademarks of DevOpsCoin LLC.
      ...
      <section className="mt-8 text-sm text-gray-400 border-t border-gray-700 pt-4">
        ...
        <p>
          To verify any official materials, filings, or third-party listings, please contact
          DevOpsCoin LLC through our official GitHub organization or via our{" "}
          <a
