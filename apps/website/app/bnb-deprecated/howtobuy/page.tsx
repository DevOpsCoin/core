    ...
    <section className="container max-w-3xl mx-auto mt-12 p-8 bg-gray-900 rounded-xl shadow-lg text-left">
      ...
      <div className="bg-gray-800 border border-cyan-700/40 rounded-lg p-5 mb-10">
        ...
        <p className="text-gray-300 mb-3">
          ...
          page. It connects directly to PancakeSwap and lets you swap BNB →
          $DEVOPS without leaving the site.
        </p>
        <p className="text-gray-400 text-sm">
          You’ll confirm each transaction in your wallet (MetaMask, Trust
          Wallet, etc.). After your first swap, you can add the token to your
          wallet so your balance appears automatically.
        </p>
      </div>
      ...
      <ol className="list-decimal list-inside space-y-5 text-gray-300">
        <li>
          ...
          <ul className="list-disc list-inside ml-6 mt-2 space-y-2">
            <li>
              <strong className="text-teal-300">MetaMask (Recommended)</strong>{' '}
              — easiest for most users. Add the BNB Smart Chain manually under{' '}
            ...
            <li>
              <strong>Coinbase / Base Wallet:</strong> Works via WalletConnect
              as well.
            </li>
            <li>
              <strong>WalletConnect (Universal):</strong> Supports Trust Wallet,
              SafePal, OKX, etc.
            </li>
          </ul>
        </li>
        ...
        <li>
          ...
          and connect your wallet. Verify you’re on the official site before
          swapping.
        </li>

        <li>
          <span className="font-semibold text-teal-400">
            Import the $DEVOPS Token:
          </span>{' '}
          Paste the official contract address into PancakeSwap’s “Select Token”
          field:
        ...
        <li>
          ...
          Enter the amount of BNB, set “To” as $DEVOPS, adjust slippage to
          ~0.5–1%, click “Swap,” and confirm in your wallet.
        </li>
        ...
        <li>
          ...
          <strong>“Import Tokens”</strong> and paste the same contract address
          above. MetaMask will detect <code>DEVOPS</code> and 18 decimals
          automatically.
        </li>
      ...
      <div className="mt-12 border-t border-gray-700 pt-8">
        ...
        <div className="space-y-6 text-gray-300">
          <div>
            ...
            <p>
              That’s normal the first time. Use the “Add $DEVOPS to MetaMask”
              button on the{' '}
              <Link href="/buy" className="text-cyan-300 underline">
                Buy page
              </Link>{' '}
          ...
          <div>
            ...
            <p>
              Yes. Once you’ve swapped once, most wallets will automatically
              route future swaps through PancakeSwap’s $DEVOPS liquidity pool.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              The site supports <strong>MetaMask (recommended)</strong>,
              Rainbow, Base/CB Wallet, and any WalletConnect-compatible option.
            </p>
          </div>
        </div>
      </div>
