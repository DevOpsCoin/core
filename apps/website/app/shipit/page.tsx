      ...
      <div className="relative" style={{ zIndex: 3 }}>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-cyan-300 mb-2 flex items-center gap-2">
            ...
            Verify Grants On-Chain
          </h2>
          <p className="text-gray-300 mb-4">
            All approved grants are permanently logged in the{' '}
            <a
              href="https://github.com/DevOpsCoin/core/tree/main/shipit-fund/ledger"
              target="_blank"
              rel="noopener noreferrer"
            ...
            . Each record includes project details, funding amount, and Solana
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://github.com/DevOpsCoin/core/issues/new?assignees=&labels=submission&template=project_submission.yml&path=shipit-fund"
              target="_blank"
