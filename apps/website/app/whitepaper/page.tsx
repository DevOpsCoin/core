    ...
    <section className="relative max-w-4xl mx-auto mt-8 p-8 rounded-xl overflow-hidden text-left shadow-lg">
      ...
      <div className="absolute inset-0">
        ...
        <img
          ...
          className="absolute right-0 top-0 max-w-[50%] w-auto h-auto object-contain opacity-25 pointer-events-none select-none"
          aria-hidden="true"
        />
      </div>

      {/* Title */}
      <h1 className="relative text-4xl font-extrabold text-cyan-300 mb-6 z-10">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-3 mb-6">
        ...
        <li>
          <strong>Public Supply (75%):</strong> Distributed through the Pump.fun
          launch curve and Raydium liquidity migration.
        </li>
      </ul>
      ...
      <p className="text-gray-300 mb-6">
        ...
        where early liquidity bootstraps Raydium trading. Once migrated, $DEVOPS
        becomes tradable through <strong>Jupiter</strong> and other Solana DEXs.
      </p>
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2 mb-6">
        <li>
          All wallet addresses are published publicly on the DevOpsCoin website.
        </li>
        <li>
