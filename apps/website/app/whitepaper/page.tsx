    ...
    <>
      ...
      <section className="container max-w-4xl mx-auto mt-12 p-8 bg-gray-900 rounded-xl shadow-lg text-left border border-cyan-700/40">
        ...
        <p className="text-gray-300 text-lg mb-6">
          The <strong>Ship-It Fund</strong> begins with a{' '}
          <strong>5 % bootstrap allocation (50 M DEVOPS)</strong> in the Ship-It
          / Operations wallet. Ongoing sustainability is powered by a portion of{' '}
          <strong>creator-reward inflows</strong> from on-chain activity. If
          volume goals aren’t met for a month, open-source grants are paused and
          rolled forward transparently once the fund is replenished.
        </p>
        <p className="text-gray-400 text-sm mb-6">
          Every transaction is public and logged to the{' '}
          <a
      ...
      <section className="container max-w-4xl mx-auto mt-8 px-3 sm:px-6 py-4 bg-gray-800 rounded-lg text-left border border-cyan-700/40">
        <p className="text-gray-300 text-base sm:text-lg">
          ...
          <br />
          Early liquidity will roll out gradually on <strong>Solana</strong> as
          the ecosystem expands and creator-reward systems stabilize.
        </p>
      ...
      <section className="container max-w-4xl mx-auto mt-12 mb-6 p-6 bg-gray-900 rounded-xl text-center border border-cyan-700/40">
        ...
        <ul className="text-gray-300 text-left list-disc pl-6 mb-3 space-y-1">
          ...
          <li>
            <strong>Ship-It / Operations Fund:</strong> 5 % — bootstrap
            allocation (50 M DEVOPS) sustained by creator-reward inflows; grants
            pause and roll forward if monthly volume criteria aren’t met.
          </li>
          <li>
