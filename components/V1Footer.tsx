...
export default function V1Footer() {
  ...
  return (
    <footer className="mt-16 border-t border-gray-800 py-6 text-sm text-gray-400 text-center relative overflow-hidden">
      ...
      <div id="footer-launch" className="mb-3 text-cyan-300 font-medium flex justify-center items-center gap-2">
      ...
      <p className="mb-1">
        ...
        <Link href="/legal" className="text-cyan-400 hover:underline">Legal</Link> ·
        <a href="mailto:team@devopscoin.ai" className="text-cyan-400 hover:underline">team@devopscoin.ai</a>
      </p>
